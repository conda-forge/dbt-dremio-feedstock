...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dbt-dremio-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dbt-dremio-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install dbt-dremio
```
...
It is possible to list all of the versions of `dbt-dremio` available on your platform:
...
```
pixi search dbt-dremio --channel conda-forge
```
